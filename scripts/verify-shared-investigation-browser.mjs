...
try {
  ...
  results.push("Real Storage denies non-owner direct reads; assignment revocation denies exact order across reloads while active investigator retains empty work dashboard");
