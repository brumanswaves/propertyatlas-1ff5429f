...
is 'Applies audited founder fulfillment using canonical report_order_status values fulfilling/complete while preserving processing/ready product labels.';
