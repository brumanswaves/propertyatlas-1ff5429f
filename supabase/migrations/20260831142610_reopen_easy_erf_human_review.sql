...
is 'Applies audited founder fulfillment, including an explicit ready-to-processing reopen for report replacement, using canonical report_order_status values fulfilling/complete.';
