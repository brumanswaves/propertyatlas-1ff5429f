...
function SalesTab({ property }: { property: Property }) {
  ...
  function exportPDF() {
    ...
    win.document.write(`<!doctype html><html><head><meta charset="utf-8" />
      <title>ErfStop · ${property.street} · 10-Year History</title>
      <style>
      ...
      <div style="margin-top:16px;padding:12px 14px;border:1px solid #fde68a;background:#fffbeb;border-radius:10px;font-size:11px;color:#78350f;line-height:1.5">
        <strong>Important:</strong> ErfStop estimates are automated informational estimates and are not certified valuations or appraisals. This report is provided for informational purposes only and is not a professional valuation, legal opinion, or investment recommendation.
      </div>
      ...
      <footer>
        <span>ErfStop · Investor Report</span>
