            ...
            {isOverview ? (
              <>
                <div className="relative">
                  ...
                  <div className="mt-8 rounded-[1.9rem] border border-[#D9E6F2] bg-[#F7FBFF] p-5 shadow-[0_22px_55px_-42px_rgba(13,27,42,0.55)]">
                    <div className="flex flex-col gap-2 sm:flex-row sm:items-end sm:justify-between">
                      <div>
                        <div className="text-[10px] font-bold uppercase tracking-[0.18em] text-[#FF6A00]">
                          ErfStoep Report Builder
                        </div>
                        <h4 className="mt-2 text-2xl font-semibold tracking-tight text-[#0D1B2A]">
                          This erf file becomes one final report.
                        </h4>
                        <p className="mt-2 max-w-2xl text-sm leading-6 text-[#0D1B2A]/64">
                          The dashboard below is live: it uses your identity checks, reviewed
                          sources, saved comps, calculator starts, and report activity.
                        </p>
                      </div>
                      <span className="inline-flex rounded-full bg-white px-3 py-1 text-[10px] font-bold uppercase tracking-[0.14em] text-[#0D1B2A] ring-1 ring-[#D9E6F2]">
                        No fake progress
                      </span>
                    </div>
                      ...
                      <div className="space-y-2">
                        {reportProgress.map((row) => (
                          <div
                            key={row.id}
                            className={cn(
                              "rounded-[1.2rem] border p-3 shadow-[0_14px_32px_-30px_rgba(13,27,42,0.45)]",
                          ...
                          >
                            <div className="flex items-start justify-between gap-3">
                              <div>
                                ...
                                <p className="mt-1 text-xs leading-5 opacity-75">{row.detail}</p>
                              </div>
                              <span className="shrink-0 rounded-full bg-white/75 px-2 py-1 text-[10px] font-bold uppercase tracking-[0.12em] text-[#0D1B2A] ring-1 ring-[#0D1B2A]/8">
                                {row.status}
                              </span>
                            </div>
                            <div className="mt-2 rounded-xl bg-white/70 px-3 py-2 text-[11px] font-semibold text-[#0D1B2A]/64">
                              {row.evidence}
                            </div>
                          </div>
                        ))}
                      ...
                      <div className="grid gap-3 sm:grid-cols-2">
                        {reportActions.map((action) => (
                          <button
                            ...
                            className={cn(
                              "rounded-[1.4rem] border p-4 text-left shadow-[0_16px_38px_-34px_rgba(13,27,42,0.42)] transition hover:-translate-y-0.5 hover:shadow-[0_24px_55px_-34px_rgba(13,27,42,0.55)]",
                              action.primary
                          ...
                          >
                            <div className="flex items-start justify-between gap-3">
                              <div>
                                ...
                                <p className="mt-2 text-sm leading-6 text-[#0D1B2A]/64">
                                  {action.body}
                                </p>
                              </div>
                              <span className="rounded-full bg-[#0D1B2A]/8 px-2 py-1 text-[10px] font-bold uppercase tracking-[0.12em] text-[#0D1B2A]/68">
                                {action.stat}
                              </span>
                            </div>
                            <span
