...
export function SearchBar({
  ...
  return (
    <div className="relative w-full max-w-2xl">
      <div className="group flex items-center gap-2.5 rounded-2xl border border-white/12 bg-[#0D1B2A]/88 px-3 py-2.5 ring-1 ring-[#FF6A00]/18 shadow-[0_18px_50px_-20px_rgba(0,0,0,0.65),0_2px_8px_-2px_rgba(255,106,0,0.22)] backdrop-blur-xl transition focus-within:bg-[#0D1B2A]/96 focus-within:ring-2 focus-within:ring-[#FF6A00]/55 md:px-4 md:py-3">
        <Search className="h-4 w-4 shrink-0 text-[#FFB86B]" />
        <button
          type="button"
          onClick={() => setOpen(true)}
          className="w-full bg-transparent text-left text-[14px] font-medium text-white outline-none"
        >
