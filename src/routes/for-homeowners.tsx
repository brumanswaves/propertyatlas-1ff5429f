...
export const Route = createFileRoute("/for-homeowners")({
  head: () => ({
    meta: [
      { title: "PropertyAtlas for Homeowners" },
      ...
      { property: "og:title", content: "PropertyAtlas for Homeowners" },
...
function ForHomeowners() {
  return (
    <MarketingPage
      ...
      intro="PropertyAtlas gives homeowners a clear, map-based view of their own property and the area around it — so you can stay informed without sifting through listings."
    ...
    >
      <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
        ...
        <Card icon={<Home className="h-5 w-5" />} title="Built for you, not the agent" accent>
          We do not sell your data to brokers. PropertyAtlas is research-first — you stay in control.
        </Card>
      </div>

      <CTASection
        title="Start with your own property"
        description="Open the map, search your address, and see what PropertyAtlas knows about your home."
        primary={{ label: "Search the Map", to: "/" }}
        secondary={{ label: "Why PropertyAtlas", to: "/why" }}
      />
    </MarketingPage>
  );
}
