...
export const Route = createFileRoute("/roadmap")({
  head: () => ({
    meta: [
      ...
      { property: "og:title", content: "ErfStoep Roadmap" },
      { property: "og:description", content: "Where ErfStoep is today and where it's going next." },
    ],
  }),
  component: Roadmap,
});
...
function Roadmap() {
  return (
    <MarketingPage
      ...
      subtitle="A high-level view of how ErfStoep is expanding."
