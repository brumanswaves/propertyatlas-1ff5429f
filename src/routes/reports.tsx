...
export const Route = createFileRoute("/reports")({
  head: () => ({
    meta: [
      { title: "Report Marketplace — ErfStop" },
      ...
      { property: "og:title", content: "Report Marketplace — ErfStop" },
    ...
    <div className="flex min-h-screen flex-col bg-background">
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-6 pb-16 pt-28">
        ...
        <p className="mt-2 max-w-2xl text-xs text-muted-foreground">
          Reports are provided by third-party data providers. ErfStop does not alter official report data.
        </p>
