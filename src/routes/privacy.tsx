...
export const Route = createFileRoute("/privacy")({
  head: () => ({
    meta: [
      { title: "Privacy Policy — PropertyAtlas" },
      { name: "description", content: "PropertyAtlas Privacy Policy. How we collect, use, and protect personal information in line with POPIA." },
    ],
  }),
...
function PrivacyPage() {
  return (
    <LegalPage
      ...
      intro="This policy explains how PropertyAtlas collects, uses, and protects your personal information in line with the Protection of Personal Information Act (POPIA)."
    >
      ...
      <LegalSection title="How We Use Information">
        <LegalList items={[
          "to provide and operate the PropertyAtlas platform",
      ...
      <LegalSection title="Cookies and Analytics">
        <p>
          PropertyAtlas uses cookies for authentication, session management, and aggregated
      ...
      <LegalSection title="Information Sharing">
        <p>
          PropertyAtlas does not sell personal information. We may share information with
