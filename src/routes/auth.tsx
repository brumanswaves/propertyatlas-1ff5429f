  ...
  return (
    <div className="grid min-h-screen md:grid-cols-2">
      <div className="hidden flex-col justify-between bg-gradient-brand p-10 text-white md:flex">
        <Link to="/" className="inline-flex w-fit items-center" aria-label="Easy Erf home">
          <AtlasPin variant="white" className="h-14 w-auto object-contain" title={BRAND.site} />
        </Link>
      ...
      <div className="flex items-center justify-center p-6">
        <div className="w-full max-w-sm">
          <div className="mb-6 flex justify-center md:hidden">
            <AtlasPin variant="horizontal" className="h-10 w-auto object-contain" title={BRAND.site} />
          </div>
