...
export const Route = createFileRoute("/profile")({
  head: () => ({
    meta: [
      { title: "Profile - PropertyAtlas" },
      { name: "description", content: "Manage your PropertyAtlas profile details." },
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <p className="mt-1 text-sm text-muted-foreground">
                This is your PropertyAtlas user profile info. It is not official parcel data.
              </p>
            </div>
          </div>
