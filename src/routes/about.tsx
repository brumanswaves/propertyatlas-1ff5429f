...
export const Route = createFileRoute("/about")({
  head: () => ({
    meta: [
      { title: "About Easy Erf — Public-Data Property Research" },
      { name: "description", content: "Easy Erf is a public-data property research workspace for South African real estate. Pilot: St Francis Bay and Kouga Municipality." },
...
function AboutPage() {
  return (
    <MarketingPage
      ...
      intro="Easy Erf helps users organise public parcel data, municipal context, listing research, notes, calculators, and third-party report requests in one place. It is not a valuer, estate agency, deeds provider, law firm, or financial adviser."
    ...
    >
      ...
      <section className="mt-12">
        <SectionHeading
          ...
          subtitle="Easy Erf focuses on organising research around a parcel — CSG cadastral, municipal context, your notes, listing URLs you've found, and the reports you plan to order."
        />
      ...
      <section className="mt-12 rounded-3xl border border-border bg-card p-8 shadow-soft">
        <SectionHeading eyebrow="Honesty" title="What Easy Erf does not do (yet)" />
        <Prose>
          <p>
            Easy Erf does not currently provide verified ownership history, transfer history, bonds, AVM valuations,
