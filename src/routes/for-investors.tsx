...
export const Route = createFileRoute("/for-investors")({
  head: () => ({
    meta: [
      { title: "PropertyAtlas for Investors" },
      ...
      { property: "og:title", content: "PropertyAtlas for Investors" },
...
function ForInvestors() {
  return (
    <MarketingPage
      ...
      intro="PropertyAtlas gives investors a Bloomberg-style view of residential, vacant land, and commercial parcels: scores, signals, sales history, and ownership intelligence in one place."
      heroCta={{ label: "Open the Map", to: "/" }}
    >
      <section>
        <SectionHeading title="What investors do on PropertyAtlas" />
