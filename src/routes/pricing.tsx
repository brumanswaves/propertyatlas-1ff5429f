  ...
  head: () => ({
    meta: [
      { title: "Pricing | Easy Erf" },
      {
        name: "description",
        content:
          "Start an Easy Erf property investigation without a subscription, or join the R999 Early Access human-reviewed Property Investigation. Optional third-party evidence and beta Site Potential allowances remain separate.",
      },
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-6 pb-24 pt-32">
        <div className="text-center">
          ...
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-muted-foreground sm:text-base">
            Easy Erf is keeping the MVP commercial model simple. Use the core investigation yourself, or choose Early Access when you want Easy Erf to do more of the investigation with human review.
          </p>
        </div>
        ...
        <section className="mt-12 overflow-hidden rounded-3xl border border-accent/35 bg-gradient-to-br from-accent/10 via-card to-primary/5 shadow-panel">
          <div className="grid gap-0 lg:grid-cols-[0.9fr_1.1fr]">
            <div className="border-b border-border/70 p-7 lg:border-b-0 lg:border-r">
              ...
              <h2 className="mt-2 text-2xl font-semibold tracking-tight">Easy Erf Property Investigation</h2>
              <div className="mt-4 flex items-end gap-2">
                <span className="text-4xl font-semibold tracking-tight">R999</span>
                <span className="pb-1 text-xs text-muted-foreground">one property, introductory price</span>
              </div>
