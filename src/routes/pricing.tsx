...
const TIERS = [
  {
    ...
    price: "R0",
    period: "forever",
    blurb: "Explore the map and discover properties.",
    cta: "Start exploring",
    features: ["Full map access", "Basic property profiles", "Search by address & erf", "Limited filters"],
  },
  {
    name: "Investor",
    price: "R199",
    period: "/ month",
    blurb: "For active property buyers and investors.",
    cta: "Start free trial",
    featured: true,
    features: [
      "Everything in Free",
      "Ownership history & duration",
  ...
  },
  {
    ...
    price: "R499",
    period: "/ month",
    blurb: "For developers, agents, and analysts.",
    cta: "Talk to sales",
    features: [
