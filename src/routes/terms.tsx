...
export const Route = createFileRoute("/terms")({
  head: () => ({
    meta: [
      { title: "Terms of Use — PropertyAtlas" },
      { name: "description", content: "PropertyAtlas Terms of Use. The terms that govern your access to and use of the PropertyAtlas platform." },
    ],
  }),
  component: TermsPage,
});
...
function TermsPage() {
  return (
    <LegalPage
      title="Terms of Use"
      intro="These Terms of Use govern your access to and use of PropertyAtlas. By using the platform you agree to be bound by these terms."
    >
      <LegalSection title="1. About PropertyAtlas">
        <p>
          PropertyAtlas is a property intelligence and research platform that aggregates,
      ...
      <LegalSection title="2. Acceptable Use">
        <p>By using PropertyAtlas you agree not to:</p>
        <LegalList items={[
          "scrape, harvest, or systematically extract data without written permission",
          "resell, redistribute, or sublicense PropertyAtlas data",
      ...
      <LegalSection title="5. Intellectual Property">
        <p>
          ...
          software, is owned by PropertyAtlas and protected by intellectual property laws.
        </p>
      </LegalSection>
      ...
      <LegalSection title="7. Limitation of Liability">
        <p>
          To the maximum extent permitted by law, PropertyAtlas shall not be liable for any
      ...
      <LegalSection title="8. Changes">
        <p>
          PropertyAtlas may modify these Terms at any time. Continued use of the platform
