...
export const Route = createFileRoute("/subscriptions")({
  head: () => ({
    meta: [
      { title: "Premium Subscription Terms — PropertyAtlas" },
      { name: "description", content: "Terms governing PropertyAtlas premium subscriptions: renewals, refunds, feature changes, and data availability." },
    ],
  }),
...
function SubscriptionsPage() {
  return (
    <LegalPage
      ...
      intro="These terms apply to all paid PropertyAtlas subscriptions and are in addition to the Terms of Use."
    >
      ...
      <LegalSection title="Changes to Features and Pricing">
        <p>
          PropertyAtlas may change features, pricing, or functionality at any time. We will
