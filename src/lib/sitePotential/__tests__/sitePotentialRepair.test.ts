...
describe("Site Potential production-blocker repair", () => {
  ...
  it("keeps historical worker migrations portable without seeding deployment configuration", () => {
    ...
    expect(migrationNames).toEqual([
      ...
      "20260831113000_secure_easy_erf_report_delivery.sql",
      ...
      "20260903211000_record_manual_report_notification.sql",
      "20260904114500_automatic_report_ready_email.sql",
      "20260907100000_founder_queue_metadata_read.sql",
      "20260909094547_shared_investigation_fulfillment.sql",
      "20260911180000_recover_failed_easy_erf_investigation.sql",
      "20260912133210_secure_investigator_onboarding.sql",
      "20260913161422_founder_account_access.sql",
    ]);
  });
