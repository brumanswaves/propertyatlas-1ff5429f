...
// Important: old csggis.drdlr.gov.za links do not resolve reliably for users.
// Always use the Experience Builder viewer URL below for CSG.

export const CSG_VIEWER_URL =
  "https://csggis.dlrrd.gov.za/portal/apps/experiencebuilder/experience/?id=a9a8f908e82c443b9cb7bede69f5985e";
...
export const DFFE_EGIS_URL = "https://www.dffe.gov.za/egis";
export const SANBI_BGIS_URL = "https://www.sanbi.org/link/bgis-biodiversity-gis/";
export const GOVZA_DEEDS_GUIDANCE_URL =
